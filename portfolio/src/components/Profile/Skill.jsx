      ...
      items: [
        {
          des: (
            <>
              저는 <strong style={{ color: "blue" }}>소통</strong>을 가장
              중요하게 생각하며, 팀워크를 통해 협력하는 것을 선호합니다.
      ...
      items: [
        {
          des: (
            <>
              ...
              프론트엔드 개발에서 발생할 수 있는{" "}
              <strong style={{ color: "red" }}>UI/UX 문제</strong>를 빠르게
              파악하고 해결하려 노력합니다.
            </>
          ),
        },
      ...
      items: [
        {
          des: (
            <>
              저는 빠르게 변화하는 기술 환경에{" "}
              <strong style={{ color: "purple" }}>적응하는 능력</strong>이
              중요하다고 생각합니다. 새로운 기술이나 프레임워크가 등장할 때
      ...
      items: [
        {
          des: (
            <>
              <strong style={{ color: "orange" }}>작은 디테일</strong>에도 신경
              쓰는 것이 프론트엔드 개발의 핵심이라고 생각합니다. 사용자 경험을
              개선하기 위해 인터페이스의 작은 요소까지 꼼꼼히 점검하며, 퍼포먼스
              최적화와 디자인 일관성에 특별히 주의를 기울입니다.
            </>
          ),
        },
      ],
