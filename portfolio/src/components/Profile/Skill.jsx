...
const Skill = () => {
  ...
  const softSkills = [
    ...
    },
    {
      ...
      items: [
        {
          des: "저는 문제를 분석하고 해결하는 데 있어 논리적이고 창의적인 접근을 중요시합니다. 복잡한 문제를 단계적으로 나누어 해결하고, 다양한 솔루션을 모색하여 최적의 결과를 도출하는 과정을 즐깁니다. 특히 프론트엔드 개발에서 발생할 수 있는 UI/UX 문제를 빠르게 파악하고 해결하려 노력합니다.",
        },
      ],
    },
    {
      ...
      items: [
        {
          des: "저는 빠르게 변화하는 기술 환경에 적응하는 능력이 중요하다고 생각합니다. 새로운 기술이나 프레임워크가 등장할 때 유연하게 학습하고, 필요할 경우 기존의 방식을 바꾸는 데 두려움이 없습니다. 프론트엔드 개발에서 최신 트렌드와 도구들을 적극적으로 활용하려고 합니다.",
        },
      ],
    },
    {
      ...
      items: [
        {
          des: "작은 디테일에도 신경 쓰는 것이 프론트엔드 개발의 핵심이라고 생각합니다. 사용자 경험을 개선하기 위해 인터페이스의 작은 요소까지 꼼꼼히 점검하며, 퍼포먼스 최적화와 디자인 일관성에 특별히 주의를 기울입니다.",
        },
      ],
    },
  ];
